...
Stmt : _SYMB_2 {  $$ = new Empty(); $$->line_number = yy_mylinenumber;  } 
  ...
  | IdentExpan _SYMB_7 _SYMB_32 _IDENT_ _SYMB_2 {  $$ = new NewClass($1, $4); $$->line_number = yy_mylinenumber;  }
...
Item : _IDENT_ {  $$ = new NoInit($1); $$->line_number = yy_mylinenumber;  } 
  ...
  | _IDENT_ _SYMB_7 _SYMB_32 _IDENT_ {  $$ = new InitClass($1, $4); $$->line_number = yy_mylinenumber;  }
;
...
Expr6 : _SYMB_0 Type _SYMB_10 {  $$ = new ENullCast($2); $$->line_number = yy_mylinenumber;  } 
  ...
  | IdentExpan _SYMB_0 ListExpr _SYMB_1 {  std::reverse($3->begin(),$3->end()) ;$$ = new EApp($1, $3); $$->line_number = yy_mylinenumber;  }
