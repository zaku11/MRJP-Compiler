...
/********************   ProgramDef    ********************/
ProgramDef::ProgramDef(ListTopDef *p1)
{
  listtopdef_ = p1;

}

ProgramDef::ProgramDef(const ProgramDef & other)
{
  listtopdef_ = other.listtopdef_->clone();

}

ProgramDef &ProgramDef::operator=(const ProgramDef & other)
{
  ProgramDef tmp(other);
  swap(tmp);
  return *this;
}

void ProgramDef::swap(ProgramDef & other)
{
...
void ProgramDef::accept(Visitor *v)
{
  v->visitProgramDef(this);
}

ProgramDef *ProgramDef::clone() const
{
  return new ProgramDef(*this);
}
...
/********************   IdentExp    ********************/
IdentExp::IdentExp(IdentExpan *p1, Ident p2)
{
  identexpan_ = p1;
  ident_ = p2;
...
IdentExp::IdentExp(const IdentExp & other)
{
...
IdentExp &IdentExp::operator=(const IdentExp & other)
{
  IdentExp tmp(other);
  swap(tmp);
  return *this;
...
void IdentExp::swap(IdentExp & other)
{
...
{
  v->visitIdentExp(this);
}

IdentExp *IdentExp::clone() const
{
  return new IdentExp(*this);
}
...
IdentExpSimple::IdentExpSimple(const IdentExpSimple & other)
{
  ident_ = other.ident_;

}

IdentExpSimple &IdentExpSimple::operator=(const IdentExpSimple & other)
{
  IdentExpSimple tmp(other);
  swap(tmp);
  return *this;
}

void IdentExpSimple::swap(IdentExpSimple & other)
{
  std::swap(ident_, other.ident_);

}

IdentExpSimple::~IdentExpSimple()
{

}

void IdentExpSimple::accept(Visitor *v)
{
  v->visitIdentExpSimple(this);
}
...
ArgDef::ArgDef(const ArgDef & other)
{
  type_ = other.type_->clone();
  ident_ = other.ident_;
...
ArgDef &ArgDef::operator=(const ArgDef & other)
{
  ArgDef tmp(other);
  swap(tmp);
  return *this;
...
void ArgDef::accept(Visitor *v)
{
  v->visitArgDef(this);
}

ArgDef *ArgDef::clone() const
{
...
/********************   BlockDef    ********************/
BlockDef::BlockDef(ListStmt *p1)
{
  liststmt_ = p1;

}

BlockDef::BlockDef(const BlockDef & other)
{
  liststmt_ = other.liststmt_->clone();

}

BlockDef &BlockDef::operator=(const BlockDef & other)
{
  BlockDef tmp(other);
  swap(tmp);
  return *this;
...
void BlockDef::swap(BlockDef & other)
{
...
void BlockDef::accept(Visitor *v)
{
  v->visitBlockDef(this);
}
